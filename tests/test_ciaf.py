...
from ciaf.provenance import ModelAggregationKey, ProvenanceCapsule, TrainingSnapshot
...
class TestModelWrapper(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.wrapper = CIAFModelWrapper(model=self.mock_model, model_name="TestWrapper")
