...
class CIAFTagGenerator:
    ...
    def create_tag(self,
        ...
        model_hash = self._generate_model_hash(model_name, model_version, training_snapshot_id)
        
        # Set defaults
        uncertainty_estimate = uncertainty_estimate or {"total": 0.5, "aleatoric": 0.3, "epistemic": 0.2}
    ...
    def _generate_tag_id(self, content: Any, model_name: str, training_snapshot_id: str) -> str:
        """Generate unique tag ID."""
    ...
    def _generate_model_hash(self, model_name: str, model_version: str, training_snapshot_id: str) -> str:
...
def create_text_tag(text: str,
                   model_name: str,
                   model_version: str,
                   training_snapshot_id: str,
                   dataset_anchor_id: str,
                   inference_receipt_hash: str,
                   **kwargs) -> CIAFMetadataTag:
...
def create_classification_tag(prediction: Any,
                             model_name: str,
                             model_version: str,
                             training_snapshot_id: str,
                             dataset_anchor_id: str,
