...
class UncertaintyMetrics:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        optional_fields = [
            ...
            "total_uncertainty", "entropy", "mutual_information", 
            "explainability_ref"
        ]
...
def demo_uncertainty_quantification():
    ...
    mc_uncertainty = quantifier.quantify_monte_carlo_dropout(
        ...
        explainability_ref="shap_values_job_001.json"
    )
    
    print(f"   Prediction Variance: {mc_uncertainty.prediction_variance:.6f}")
    print(f"   Confidence Interval: [{mc_uncertainty.confidence_interval.lower_bound:.3f}, {mc_uncertainty.confidence_interval.upper_bound:.3f}]")
    ...
    ensemble_uncertainty = quantifier.quantify_deep_ensembles(
        ensemble_samples,
        explainability_ref="ensemble_shap_job_001.json"
    )
    ...
    eu_validation = quantifier.validate_uncertainty_requirements(mc_uncertainty, "EU_AI_ACT")
    nist_validation = quantifier.validate_uncertainty_requirements(mc_uncertainty, "NIST_AI_RMF")
