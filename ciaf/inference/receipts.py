...
class InferenceReceipt:
    ...
    def __init__(self, query: str, ai_output: str, model_version: str,
                 training_snapshot_id: str, training_snapshot_merkle_root: str,
    ...
    @classmethod
    def issue(cls, query: str, ai_output: str, model_version: str,
              training_snapshot_id: str, training_snapshot_merkle_root: str,
              prev_receipt: Optional["InferenceReceipt"] = None) -> "InferenceReceipt":
        """
    ...
    def from_json(cls, json_data: dict):
        ...
        receipt.training_snapshot_merkle_root = json_data["training_snapshot_merkle_root"]
...
class ZKEChain:
    ...
    def add_receipt(self, query: str, ai_output: str, model_version: str,
                    training_snapshot_id: str, training_snapshot_merkle_root: str) -> InferenceReceipt:
        """
